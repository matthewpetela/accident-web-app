...
const Options = () => {
    const placeholderText1 = "This option lets the user choose a city and then compare it with 4 different cities. The comparison will provide information about the number of accidents, weather, and ranking."
