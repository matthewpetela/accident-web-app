...
const QuizResult = (props) => {
    ...
    function saveQuizGrade(){
        ...
        axios
        .post(process.env.NODE_ENV === 'production'?'https://accident-web-app.herokuapp.com/api/upload/userQuizResults':'http://localhost:5000/api/upload/userQuizResults',
        { data: {"quizGrade" : quizGrade} }, {headers: {"Authorization" : `bearer ${localStorage.getItem("token")}`}})
        .then(res=>{
          console.log(res);
        })
        .catch(error => {
