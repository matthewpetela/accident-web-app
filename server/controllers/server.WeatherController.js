...
const config = process.env.darkSkyKey || require('../config/config.js').darkSkyKey;
...
exports.report = (req,res)=> {
    ...
    axios
        .get('https://api.darksky.net/forecast/'+config +'/'+found['coordinates'][0]+','+found['coordinates'][1], this.state)
        .then(response => {
